# -*- coding: utf-8 -*-
"""
Created on Thu Jul 25 09:32:15 2024
...
RL = DeepQNetwork(NUM_ACTION, 
                  ...
                  epsilon_increment = 1e-6, #Next step: increase the value of epsilon_increment
...
if Train:
    for num_episode in range(NUM_EPISODE):
        ...
        epi_good_event = 0
        epi_action_list = []
        if num_episode > 80000 and num_episode < 100000:
        ...
        while True:         
            ...
            [S_, all_S_, R, isDone, IfAppear32, stop_ind, selected_action] = \
                AGV_StepFun(S, A, plant_param, NUM_ACTION, dis)
    ...
    file_path = "C:\\Users\Administrator\Desktop\AGV\\6747_reward209.60606060606102step201.ckpt" # fill in the target ckpt
    ...
    [generated_states_full, Problem_state] = RL.check_action_AGV_cluster(S, file_path, plant_param)
